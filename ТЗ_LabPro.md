...
- ✅ Справочники: типы культур, контейнеров, сред, операций
...
│ passage_number: INTEGER       Номер пассажа (P1, P2, ...)       │
...
│ status: ENUM                  ACTIVE/DISPOSE/IN_BANK            │
...
### 3.2. Сущность Ткань (Donor/Tissue)
...
├─────────────────────────────────────────────────────────────────┤
│ id: UUID                      PK                                │
│ code: VARCHAR(50)             Код донора (DN-0001)              │
│ age: INTEGER                  Возраст                           │
│ gender: ENUM                  M/F                               │
│ tissue_type: VARCHAR(100)     Тип ткани                         │
│ collection_date: DATE         Дата получения                    │
│ notes: TEXT                                                     │
│ created_at: TIMESTAMP                                          │
└─────────────────────────────────────────────────────────────────┘
...
│ status: ENUM                  ACTIVE/EXPIRED/DISPOSE            |
│ notes: TEXT                                                     │
│ created_at: TIMESTAMP                                          │
└─────────────────────────────────────────────────────────────────┘
...
| Текущий статус | Следующий статус | Условие перехода | Операция |
|----------------|------------------|------------------|----------|
| ACTIVE | ACTIVE | passage (new_container) | Passage |
| ACTIVE | IN_BANK | добавлен в банк | Freeze |
| ACTIVE | DISPOSE | утилизирован | Dispose |
...
**Содержание:**
- Информация о культуре (тип, донор, ткань)
...
| Код | Статус | Описание |
|-----|--------|----------|
| ACTIVE | Активен | Объект в работе |
| DISPOSE | Утилизирован | Объект больше не используется |
| CLOSED | Закрыт | Лот закрыт автоматически |
| QUARANTINE | Карантин | Ожидает QC или активации |
| APPROVED | Одобрен | QC пройден |
| RESERVED | Зарезервирован | Заблокирован под заявку |
| ISSUED | Выдан | Отдан заказчику |
| IN_PROGRESS | В работе | Операция выполняется |
| COMPLETED | Завершён | Операция выполнена |
| PENDING | Ожидает | Ожидает действия |
| EXPIRED | Просрочен | Истёк срок годности |
